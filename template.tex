...
% Author : Leslie Cheng
% License : MIT
% Template based on : https://github.com/lcfyi/software-resume-template
%-------------------------------------
...
\definecolor{secondary}{HTML}{0D60A1}
\definecolor{accent}{HTML}{263238}
\definecolor{links}{HTML}{1540C0}
